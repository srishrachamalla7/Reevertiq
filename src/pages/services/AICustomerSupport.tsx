...
import { Headphones, Clock, Zap, BarChart, Globe, Shield, Bot, ShoppingCart, Heart, Stethoscope } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Provide round-the-clock support to your customers with AI-powered automation.',
    },
    {
      icon: Zap,
      title: 'Instant Responses',
      description: 'Deliver fast, accurate answers to customer inquiries in real-time.',
    },
    {
      icon: BarChart,
      title: 'Performance Analytics',
      description: 'Track support metrics and customer satisfaction with detailed insights.',
    },
    {
      icon: Globe,
      title: 'Multilingual Support',
      description: 'Engage customers globally with AI that speaks their language.',
    },
    {
      icon: Shield,
      title: 'Data Security',
      description: 'Protect customer data with top-tier encryption and compliance standards.',
    },
    {
      icon: Bot,
      title: 'Smart Automation',
      description: 'Handle routine queries with AI, freeing your team for complex issues.',
    },
  ];
  ...
  const useCases = [
    {
      icon: ShoppingCart,
      title: 'E-commerce',
      description: 'Resolve order issues, track shipments, and upsell with AI support.',
    },
    {
      icon: Stethoscope,
      title: 'Healthcare',
      description: 'Assist patients with scheduling, FAQs, and basic triage support.',
    },
    {
      icon: Heart,
      title: 'Nonprofits',
      description: 'Support donors and volunteers with instant, personalized responses.',
    },
  ];
    ...
    <div className="min-h-screen bg-[#0B0F1A]">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          ...
          >
            <Headphones className="w-20 h-20 mx-auto mb-8 text-primary" />
            <h1 className="text-5xl md:text-6xl font-bold mb-6 gradient-text">
              AI Customer Support Solutions
            </h1>
            <p className="text-2xl md:text-3xl text-gray-300 mb-4">
              Elevate your customer service with intelligent, AI-driven support systems.
            </p>
            <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-12">
              Empower your team and delight your customers with scalable solutions.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300">
              Connect your AI customer support with your favorite tools effortlessly.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Enhance customer satisfaction and reduce support costs with AI.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/contact"
